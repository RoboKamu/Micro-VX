...
static void run_audio_visualizer(uint8_t cycle) {
	...
	/* denoise with a threshold and set a scale for wave ampltude, in this case +- 15px */
	const int threshold = 7;
	float scale =
			(max - mean) > threshold ? (15.0f) / (max - mean) : 15.0f / 2048.0f;
